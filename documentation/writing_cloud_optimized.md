...
Use libraries like [`s3fs`](https://s3fs.readthedocs.io/) or [`gcsfs`](https://gcsfs.readthedocs.io/) to interact with cloud storage as if it were a local file system.
