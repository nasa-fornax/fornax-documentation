...
* Please also note that if you start an instance, closing your browser window does not necessarily stop the instance you started.  Especially with the larger instances, *_please explicitly use the “Stop My Server” button_* (under File->Hub Control Panel)  when done. 
